package online.daobao.boot.web.controller;

import lombok.extern.slf4j.Slf4j;
import online.daobao.boot.web.controller.dto.AjaxResponse;
...
public class ArticleController {
    ...
    public AjaxResponse deleteArticle(@RequestParam("id") int id) {
